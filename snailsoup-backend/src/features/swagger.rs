...
use crate::features::expense::handlers::{
    __path_categories, __path_expense_by_id, __path_expenses, __path_expenses_query, __path_tags,
};
...
#[openapi(
            paths(
                ...
                expense_by_id, expenses, expenses_query, tags, categories, //Expenses
